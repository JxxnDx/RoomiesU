...
export default function HabitacionCard() {
  return (
    <article className={`flex flex-col ${COLORS["light_primary"]} shadow-lg rounded-lg p-4 m-4 transition-transform duration-300 hover:scale-105`}>	
        ...
        <div className="flex justify-between items-center mt-4">
            ...
            <NavLink to="#" className={`${COLORS["light_secundary"]} ${COLORS["hoverdark"]} rounded-lg px-4 py-2`}>Ver más</NavLink>
        </div>
    </article>
  );
}