...
const VerReseñasEstudiante = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/api/resenas-estudiante/${id}`, { withCredentials: true })
      .then(response => {
    ...
    <div className="p-8">
      ...
      {reseñas.length === 0 && !error ? (
        ...
        <div className="grid gap-4">
          {reseñas.map((reseña) => (
            <ReseñaCard key={reseña.Id_Reseña_Estudiante} reseña={reseña} />
          ))}
        </div>
      )}
    </div>
...
export default VerReseñasEstudiante;
