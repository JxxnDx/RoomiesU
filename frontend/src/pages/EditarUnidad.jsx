  ...
  return (
    <div className='min-h-screen p-8'>
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className='text-3xl font-bold mb-6'>Editar Unidad de Vivienda</h1>
        ...
        <form onSubmit={handleSubmit} className={`${COLORS["light_primary"]} border border-gray-200 rounded-lg p-6 shadow-lg`}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#01b09e]"
                required
              />
            </div>
            ...
            {/* Campo Dirección */}
            <div className="mb-4">
              <label className="block mb-2" htmlFor="direccion">
                Dirección
              </label>
              <input
                type="text"
          ...
          <div className="mt-8 flex justify-end">
            <button
              type="submit"
              className={`flex items-center ${COLORS["light_secundary"]} ${COLORS["hoverdark"]} text-white font-semibold py-2 px-6 rounded-lg shadow-lg transition duration-300`}
            >
